...
//     return f[x];
// }
// int dt(sphere a, sphere b) {
//     return sqrt(pow(a.x - b.x, 2) * 1.0 + pow(a.y - b.y, 2) * 1.0 + pow(a.z - b.z, 2) * 1.0);
// }
// int main() {
//     int T;
//     scanf("%d", &T);
...
//                 low[low2] = i;
//             }
//             if ((ss[i].z >= 0 && ss[i].z - r <= 0) || (0 >= ss[i].z && ss[i].z + r >= 0))
//                 low2 += 1, low[low2] = i;
//             if ((ss[i].z <= h && h <= ss[i].z + r) || (h >= ss[i].z - r && h <= ss[i].z))
//                 up2 += 1, up[up2] = i;
//         }
//         bool has = false;
//         if (low2 != 0 && up2 != 0) {
